...
SEARCH_DIR("/mnt/SSD/workspace/lunatic_clang/lsc/install/x86_64-pep/lib"); SEARCH_DIR("/mnt/SSD/workspace/lunatic_clang/lsc/install/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
